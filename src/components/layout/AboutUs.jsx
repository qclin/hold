        ...
        <div className="content bg-white">
          <div className="measure-wide">
            ...
            <p>
              ...
              system. We think of dominant lineages of knowledge production
              <span className="annotations">2</span> and its impact on what has
              become prevalent. We engage with existing structures directly,
              study their context and conditions in order to understand its
              strengths, uneven differences and need to foreground undermined
              information. To creatively experiment with reconfiguration
            ...
            <p>
              ...
              organizational coordination, website identities, platform
